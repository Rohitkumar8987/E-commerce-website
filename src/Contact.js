...
const Contact = () => {
    ...
    const senddata = async (e) =>
    {
        ...
        const res =await fetch('https://e-commerce-2749a-default-rtdb.firebaseio.com/Message.json',options)
        console.log(res)
        if(res)
        {
            ...
            <h2>#Contact us</h2>
                <div className="form">
                    <form method="POST">
                        ...
                        <input type="text" name='Email' value={users.Email} placeholder='Enter Your E-mail' autoComplete='off' onChange={data} ></input>
